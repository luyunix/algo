...
private static String formatStatus(JudgeResult.Status status) {
      switch (status) {
          case AC: return GREEN + BOLD + "✓ Accepted" + RESET;
          case WA: return RED + BOLD + "✗ Wrong Answer" + RESET;
          case TLE: return YELLOW + BOLD + "⏱ Time Limit Exceeded" + RESET;
          case RE: return RED + BOLD + "✗ Runtime Error" + RESET;
          case CE: return RED + BOLD + "✗ Compile Error" + RESET;
